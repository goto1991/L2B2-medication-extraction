...
class RNN_Model:
    ...
    def __init__(self, vocab_size, state_size, num_classes, dropout=1.0, learn_rate=0.01, decay=0, emb_layer=False):
    ...
    def train(self, sets, epochs=10, batch=50, report_percentage=50, show_progress=False, show_plot=False):
